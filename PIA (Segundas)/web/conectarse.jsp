    ...
    if (accion.equals("Iniciar sesion")){
        try{
            ...
            ResultSet rs = st.executeQuery("SELECT * FROM usuarios WHERE usuario = '" + usr + "' AND contra = '" + pass + "'" );   
                if(rs.next()){
                    out.println("<h3>Login OK!... <br><br> Bienvenid@!: " + usr + "</h3> <br> <a href='verusuarios.jsp'>Ver tabla usuarios</a> <br> <a href='verclientes.jsp'>Ver tabla clientes</a> <br> <a href='verproveedores.jsp'>Ver tabla proveedores</a>");
                } else {
