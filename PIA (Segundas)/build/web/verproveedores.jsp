  ...
  <body>
    ...
    <header class="masthead text-center text-white">
      <div class="masthead-content">
        <div class="container">
          ...
          <a href="#registrarme" class="btn btn-primary btn-xl rounded-pill mt-5">Ver la tabla de Proveedores</a>
        </div>
      </div>
    ...
    <section id="registrarme">
      <div class="container">
          <div align="center">
            <div class="p-4">
              <h2 class="display-5">Tabla de usuarios.</h2>
              <hr noshade>
                ...
                <%
                     ...
                     PreparedStatement ps;
                          ...
                          rs = smt.executeQuery("select * from proveedores");
                          //Creamo la Tabla:     
                      %>
                          ...
                          <!--<a  class="btn btn-success" href="Agregar.jsp">Nuevo Registro</a> Esto es Cuando se Crea un nuevo Archivo Agregar.jsp -->         
                           <table class="table table-bordered"  id="tablaDatos">
                                  ...
                                  <tbody id="tbodys">
                                      ...
                                      %>
                                      <tr>
                                          <td class="text-center"><%= rs.getString("idprov")%></td>
                                          <td><%= rs.getString("nombreprov")%></td>
                                      </tr>
                                      <%}%>
                              </table>
	          	  <hr noshade>
