  ...
  <body>
    ...
    <header class="masthead text-center text-white">
      <div class="masthead-content">
        <div class="container">
          ...
          <a href="#registrarme" class="btn btn-primary btn-xl rounded-pill mt-5">Cookie eliminada</a>
        </div>
      </div>
    ...
    <section id="registrarme">
      <div class="container">
          <div align="center">
            <div class="p-4">
              <h2 class="display-5">Resultado de eliminación de cookie.</h2>
              <hr noshade>
            ...
            if(respuesta.equals("matarcookies")){
                    ...
                    out.println("Las cookies de user y pass fueron borrados correctamente");
                    out.println("<a href='index.htm'>Regresar a la pagina de inicio</a>");
            } else {
