  ...
  <body>
    ...
    <header class="masthead text-center text-white">
      <div class="masthead-content">
        <div class="container">
          ...
          <a href="#registrarme" class="btn btn-primary btn-xl rounded-pill mt-5">Ver el error</a>
        </div>
      </div>
    ...
    <section id="registrarme">
      <div class="container">
          <div align="center">
            <div class="p-4">
              <h2 class="display-5">Se ha producido un error.</h2>
              <hr noshade>

            <h1>Se ha producido un error al iniciar sesión: <br> Sus credenciales del login no corresponden con el formulario de registro!.</h1>
	          	  <hr noshade>
          </div>
      </div>
    </section>
