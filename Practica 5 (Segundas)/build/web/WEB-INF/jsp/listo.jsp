  ...
  <body>
    ...
    <header class="masthead text-center text-white">
      <div class="masthead-content">
        <div class="container">
          ...
          <a href="#registrarme" class="btn btn-primary btn-xl rounded-pill mt-5">Ver mi usuario</a>
        </div>
      </div>
    ...
    <section id="registrarme">
      <div class="container">
          <div align="center">
            <div class="p-4">
              <h2 class="display-5">Su usuario ha sido registrado correctamente.</h2>
              <hr noshade>

	        <h1>Todo OK!</h1>
                    <br>
                    <p>Nombre: ${requestScope.estudiante.nombre}</p>
                    <p>Materia: ${requestScope.estudiante.materia}</p>
